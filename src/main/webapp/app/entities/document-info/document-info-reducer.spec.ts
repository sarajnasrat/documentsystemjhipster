...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCUMENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCUMENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCUMENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCUMENTINFO actions', async () => {
      const expectedActions = [
        {
